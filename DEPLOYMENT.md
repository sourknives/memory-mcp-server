# Cross-Tool Memory MCP Server Deployment Guide
...
The Cross-Tool Memory MCP Server can be deployed in various configurations:
...
services:
  cross-tool-memory:
    ...
    container_name: cross-tool-memory-dev
    ports:
      - "8000:8000"
    volumes:
...
services:
  cross-tool-memory:
    ...
    container_name: cross-tool-memory-prod
    ports:
