"""Main entry point for the Cross-Tool Memory Server."""
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Cross-Tool Memory Server")
    parser.add_argument(
        "--mode",
    ...
    if args.mode == "mcp":
        logger.info("Starting Cross-Tool Memory MCP Server...")
        ...
        logger.info(f"Starting Cross-Tool Memory REST API Server on {host}:{port}...")
