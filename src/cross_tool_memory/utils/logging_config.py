"""
Comprehensive logging configuration for the cross-tool memory system.
...
class LoggingConfig:
    ...
    def __init__(
        ...
        Args:
            ...
            log_dir: Directory for log files (defaults to ~/.cross_tool_memory/logs)
        ...
        if log_dir:
            ...
            self.log_dir = Path.home() / ".cross_tool_memory" / "logs"
    ...
    def setup_logging(self) -> None:
        ...
        if self.file_output:
            ...
            app_log_file = self.log_dir / "cross_tool_memory.log"
...
class ComponentLogger:
    ...
    def __init__(self, component_name: str):
        self.logger = logging.getLogger(f"cross_tool_memory.{component_name}")
...
def setup_default_logging(
    ...
    config = LoggingConfig(
        ...
        component_levels={
            "cross_tool_memory.database": "INFO",
            "cross_tool_memory.search": "INFO",
            "cross_tool_memory.mcp": "INFO",
            "cross_tool_memory.api": "INFO",
