...
This module provides a lightweight bridge between MCP hosts and remote Cortex MCP servers,
...
class RemoteMCPClient:
    """Lightweight MCP Server that proxies requests to a remote Cortex MCP server via HTTP."""
        ...
        async def handle_list_tools() -> List[Tool]:
            ...
            try:
                ...
                return [
                    ...
                    Tool(
                        name="list_memories",
                        description="List recent memories from the remote Cortex MCP server",
                        inputSchema={
                            "type": "object",
                            "properties": {
                    ...
                    Tool(
                        name="delete_memory",
                        description="Delete a memory from the remote Cortex MCP server",
                        inputSchema={
                            "type": "object",
                            "properties": {
